...
const App: React.FC = () => {
  ...
  const profile = useSpaceStore((state) => state.getProfile);
  const setProfile = useSpaceStore((state) => state.setProfile);
  ...
  useEffect(() => {
    ...
    if (!!selectedNode) {
      ...
      requestTipHeader();
      requestRepresentation(
        '5ec86acd26171026b5cfdd4004b049b3b6b6b7863f70eb0884a9864f051bb9d9',
      );
    }
